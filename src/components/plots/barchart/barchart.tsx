...
let [xLabel, yLabel] = useMemo(() => {
  ...
  }else if (contextT.curFeatureValue == "NA" || contextT.curFeatureValue == "undefined" || collectDataLoadingErrors.some((error) => error !== undefined)) {
