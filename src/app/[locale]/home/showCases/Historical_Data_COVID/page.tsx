...
export default function Home() {
  ...
  const t = useTranslations("page_home.ShowCases.page_Historical_Data_COVID");

  const UIContextT = useUIContext();
  const layoutSizes = UIContextT.layoutDims;

  const locale = useLocale() as Locale;
  const MDX = MDXContentProvider[locale];
  ...
  <>
   <main className="flex max-h-fit flex-col items-center justify-between " style={{paddingTop: layoutSizes.gapSize}}>
    <InterfaceContextProvider>
      <ViewMainInfoComponent heading={mainInfoHeading} mdxContent={MDX.pages.ShowCases.HistoricalDataCOVID} />
