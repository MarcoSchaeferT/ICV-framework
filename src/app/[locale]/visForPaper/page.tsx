     ...
     <InterfaceContextProvider>
      <main className="flex max-h-fit flex-col items-center justify-between " style={{paddingTop: layoutSizes.gapSize}}>
        ...
        {/*** Grid Cells ***/}
          ...
          <SGridPlotCard rowColSpan={[1,3]} cardProps={new CardPropsClass("Stat1","","","", )}>  </SGridPlotCard>
          <SGridPlotCard rowColSpan={[1,3]} cardProps={new CardPropsClass("Stat2","","","",)}> </SGridPlotCard>
          <SGridPlotCard rowColSpan={[1,3]} cardProps={new CardPropsClass("Stat3","","","", )}> </SGridPlotCard>
          <SGridPlotCard rowColSpan={[1,3]} cardProps={new CardPropsClass("Stat4","","","", )}>  </SGridPlotCard>

          <SGridPlotCard rowColSpan={[8,6]} cardProps={new CardPropsClass("Map1","Grid Card 1","","")}> </SGridPlotCard>
    
          
                <SGridPlotCard rowColSpan={[4,3]} cardProps={new CardPropsClass("Linechart1","Grid Card 2","","")}> </SGridPlotCard>
                <SGridPlotCard rowColSpan={[4,3]} cardProps={new CardPropsClass("Linechart2","Grid Card 3","","")}> </SGridPlotCard>
                <SGridPlotCard rowColSpan={[4,3]} cardProps={new CardPropsClass("Linechart3","Grid Card 4","","")}> </SGridPlotCard>
                <SGridPlotCard rowColSpan={[4,3]} cardProps={new CardPropsClass("Linechart4","Grid Card 5","","")}> </SGridPlotCard>
              </div>
