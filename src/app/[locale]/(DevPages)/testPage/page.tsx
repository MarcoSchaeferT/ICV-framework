...
export default function Home() {
 ...
 const layoutSizes = UI_contextT.layoutDims;
  ...
  mapPropsGermany.mapUIsettings.isFeatureSelectionDropdown = false;
  ...
  let mapPropsGermany2 = LeafD3MapGermanyProps();
  mapPropsGermany2.chartName = 'map_germany2';
  mapPropsGermany2.mapDataURL = apiRoutes.FETCH_MAP_DATA.GERMANY_MAP_STATES;
  ...
  mapPropsGermany2.mapUIsettings.isLongitudeSlider = false;
  mapPropsGermany2.mapUIsettings.isLatitudeSlider = false;
  mapPropsGermany2.mapUIsettings.isZoomSlider = false;
  mapPropsGermany2.mapUIsettings.isColorMapSelectionDropdown = false;
  mapPropsGermany2.mapUIsettings.isFeatureSelectionDropdown = false;
  mapPropsGermany2.mapUIsettings.isDatasetSelectionDropdown = false;
  mapPropsGermany2.mapUIsettings.isDistanceLegend = false;
  mapPropsGermany2.mapUIsettings.isColorMapLegend = false;
  mapPropsGermany2.isProjection_equirectangular = true;
  mapPropsGermany2.isStaticAutoFitFullSize = true;
  
  
  let mapPropsWorld = LeafD3MapLayerProps();
  mapPropsWorld.chartName = 'map_World';
  mapPropsWorld.dataURL = apiRoutes.FETCH_MAP_DATA.WORLD_MAP;
  ...
  let d3ExampleProps1 = ExampleChartProps("Example1", apiRoutes.getDatasetsMetadata({ LANGID: "en" }), "exampleVar1");
  let d3ExampleProps2 = ExampleChartProps("Example2", apiRoutes.getDatasetsMetadata({ LANGID: "en" }), "exampleVar2");
  let d3ExampleProps3 = ExampleChartProps("Example3", apiRoutes.getDatasetsMetadata({ LANGID: "en" }), "exampleVar3");
  let d3ExampleProps4 = ExampleChartProps("Example4", apiRoutes.getDatasetsMetadata({ LANGID: "en" }), "exampleVar4");
  let d3ExampleProps5 = ExampleChartProps("Example5", apiRoutes.getDatasetsMetadata({ LANGID: "en" }), "exampleVar5");
  let BarchartProps6 = BarchartProps("Example6", "apiRoutes.GET_DATASETS_METADATA", "","", true);
  let LinechartProps1 = LinechartProps("Linechart1", "A", "exampleVar1");
  LinechartProps1.isDummyMode = true;

  let PieChartProps1 = PieChartProps("Piechart1", [], "exampleVar1");
  PieChartProps1.data = [
  ...
  <>
    ...
    <InterfaceContextProvider>
      ...
      <div ref={swapContainerRef} className={`w-full grid grid-cols-12 md:grid-cols-12 pl-0`} style={{
        ...
        {/*** Grid Cells ***/}
         <SGridPlotCard rowColSpan={[6,6]} cardProps={CardPropsClass("piechart1","Heading","Sub Heading","Footer")}> <PieChartComponent ChartProps={PieChartProps1} /> 
        </SGridPlotCard>
        <SGridPlotCard rowColSpan={[2,2]} cardProps={CardPropsClass("Plot1","","","")}> <D3ExampleChartComponent chartProps={d3ExampleProps4}/> </SGridPlotCard>
        <SGridPlotCard rowColSpan={[2,3]} cardProps={CardPropsClass("Plot1.1","","","")}> <D3ExampleChartComponent chartProps={d3ExampleProps1}/> </SGridPlotCard>
        <SGridPlotCard rowColSpan={[4,5]}  cardProps={CardPropsClass("Map2","Map2","","")}> <LeafD3MapLayerComponent props={mapPropsWorld}/> </SGridPlotCard>
       <SGridPlotCard rowColSpan={[4,2]}  cardProps={CardPropsClass("Map1","","","")}> <LeafD3MapGermanyComponent props={mapPropsGermany2}/> </SGridPlotCard>
        <SGridPlotCard rowColSpan={[2,3]} cardProps={CardPropsClass("Plot2","","","")}> <D3ExampleChartComponent chartProps={d3ExampleProps2}/> </SGridPlotCard>
        <SGridPlotCard rowColSpan={[2,2]} cardProps={CardPropsClass("Plot3","","","")}> <D3ExampleChartComponent chartProps={d3ExampleProps3}/> </SGridPlotCard>
        <SGridPlotCard rowColSpan={[4,4]}  cardProps={CardPropsClass("Map3","","","")}> <LeafD3MapGermanyComponent props={mapPropsGermany}/> </SGridPlotCard>
        ...
        <SGridPlotCard rowColSpan={[2,12]} cardProps={CardPropsClass("Plot4","Heading","Sub Heading","Footer")}> <D3ExampleChartComponent chartProps={d3ExampleProps5}/> </SGridPlotCard>

        
        <SGridPlotCard rowColSpan={[4,6]} cardProps={CardPropsClass("Plot5","Heading","Sub Heading","Footer")}> <BarchartComponent chartProps={BarchartProps6} /> 
        </SGridPlotCard>
        <SGridPlotCard rowColSpan={[4,6]} cardProps={CardPropsClass("linechart1","Heading","Sub Heading","Footer")}> <LinechartComponent chartProps={LinechartProps1} /> 
        </SGridPlotCard>
